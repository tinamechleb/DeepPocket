...
import GrandExpensesCard from './GrandExpensesCard';
...
class RecurringExpenses extends Component {
    ...
    componentWillMount() {
        fetch('http://127.0.0.1:8000/api/transactions/expense/recurring', {
            method: 'GET',
            headers: {
